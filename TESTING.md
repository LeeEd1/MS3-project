...
I had one error whilst checking html code through [w3c](https://validator.w3.org/). This was due to a stray div in one of my templates, to find this issue I right clicked the page and then clicked view page source to locate the stray div to see the surrounding code. I was then able to see which template this was in.
...
I passed my file through js hint, the file only contains Jquery code and shows no errors however it states $ is undefined which is not an issue as it's related to jquery.
